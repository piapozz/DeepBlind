...
public class StopLookAt : ISkill
{
    ...
    public EnemyBase.EnemyInfo Ability(EnemyBase.EnemyInfo info)
    {
        ...
        targetPoints[0] = bounds.min;
        targetPoints[1] = new Vector3(bounds.max.x, bounds.min.y, bounds.min.z);
        targetPoints[2] = new Vector3(bounds.min.x, bounds.max.y, bounds.min.z);
        targetPoints[3] = new Vector3(bounds.min.x, bounds.min.y, bounds.max.z);
        targetPoints[4] = new Vector3(bounds.max.x, bounds.max.y, bounds.min.z);
        targetPoints[5] = new Vector3(bounds.max.x, bounds.min.y, bounds.max.z);
